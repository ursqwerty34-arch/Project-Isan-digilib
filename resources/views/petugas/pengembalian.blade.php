...
<div class="pengajuan-card">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                        <button class="btn-konfirmasi-kembali"
                            data-id="{{ $loan->id }}"
            ...
            @empty
            <tr><td colspan="8" class="empty-row">Tidak ada pengembalian pending.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="pengajuan-section-title" style="margin-top:32px;">
        Daftar pengembalian yang petugas - {{ Auth::user()->name }} konfirmasi
    </div>
    <table class="pengajuan-table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td><div class="cover-thumb">@if($ret->loan->book->cover)<img src="{{ asset('storage/'.$ret->loan->book->cover) }}" alt="">@endif</div></td>
                ...
                <td>
                    @if($ret->fine_status === 'belum_lunas')
                        <button class="btn-lunas-denda"
                            data-url="{{ route('petugas.pengembalian.lunas', $ret) }}">
                            Tandai Lunas
                        </button>
                ...
                <td>
                    <a href="{{ route('petugas.pengembalian.detail', $ret) }}" class="btn-detail-icon" title="Detail">&#128441;</a>
                </td>
            </tr>
            @empty
            <tr><td colspan="9" class="empty-row">Belum ada konfirmasi.</td></tr>
            @endforelse
        </tbody>
    </table>
...
<div class="modal-overlay" id="modalSuksesKonfirmasi">
    <div class="modal-box" style="max-width:420px; text-align:center;">
        ...
        <div class="modal-title" style="color:#2f5d34; font-size:17px; margin-bottom:24px;">Pengembalian buku berhasil di<br>konfirmasi...</div>
...
<div class="modal-overlay" id="modalHitungDenda">
    <div class="modal-box" style="max-width:520px; text-align:left;">
        ...
        <div class="denda-info-grid" style="background:#f9fdf9; border-radius:10px; padding:14px 16px; margin-bottom:16px; font-size:13px;">
            <div style="display:grid; grid-template-columns:100px 1fr; gap:6px 0;">
                ...
                <div style="display:flex; gap:16px; align-items:center;">
                    ...
                    <span style="color:#ef5350; font-size:11px; font-weight:700;">&#128197; <span id="dendaTglKembali"></span></span>
                </div>
            </div>
            <div style="text-align:right; margin-top:8px; font-size:12px; color:#6b6b6b;">Total telat: <span id="dendaTelat" style="font-weight:700; color:#1e1e1e;"></span> Hari</div>
        </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; align-items:start;">
                <div>
                    ...
                    <div style="display:flex; align-items:center; gap:6px;">
                        <input type="number" id="inputTelat" min="0" style="width:60px; padding:6px 8px; border:1.5px solid #a5d6a7; border-radius:6px; font-size:13px; outline:none;">
                    ...
                    <div id="jumlahBayarDisplay" style="padding:6px 10px; background:#fff; border:1.5px solid #a5d6a7; border-radius:6px; font-size:13px; color:#6b6b6b; min-width:100px;">Rp. 0</div>
                    <div style="margin-top:8px; font-weight:700; font-size:13px;">Total Bayar <span id="totalBayarDisplay" style="color:#1e1e1e;">Rp. 0</span></div>
                </div>
                <div style="font-size:12px; color:#6b6b6b; line-height:1.6; padding-top:20px;">
                    <span style="color:#6b6b6b;">Denda/Hari</span> &nbsp; <span style="font-weight:700; color:#1e1e1e;">Rp. 5.000</span><br><br>
...
<div class="modal-overlay" id="modalSuksesKirim">
    <div class="modal-box" style="max-width:420px; text-align:center;">
        ...
        <div class="modal-title" style="color:#2f5d34; font-size:17px; margin-bottom:24px;">Pemberitahuan sudah terkirim</div>
        <div class="modal-actions" style="justify-content:center;">
            <button class="btn-modal-hapus" onclick="window.location.reload()">Kembali</button>
        </div>
    </div>
