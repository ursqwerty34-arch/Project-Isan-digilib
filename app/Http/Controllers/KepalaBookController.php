...
class KepalaBookController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kepala.buku.index', compact('books'));
    }

    public function create() { return view('kepala.buku.create'); }
    ...
    public function edit(Book $book) { return view('kepala.buku.edit', compact('book')); }
