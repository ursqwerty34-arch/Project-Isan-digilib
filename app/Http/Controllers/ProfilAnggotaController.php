...
class ProfilAnggotaController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->only(['username', 'name', 'email', 'phone', 'nik', 'gender', 'birth_date', 'address', 'kelas_jurusan']);
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('anggota.profil')->with('password_success', 'Password berhasil diubah.');
    }
}